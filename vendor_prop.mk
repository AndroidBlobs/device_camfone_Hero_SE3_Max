PRODUCT_PROPERTY_OVERRIDES +=  \
    ...
    persist.prize.als_value=3 \
    persist.prize.yuv_back_value=150 \
    persist.prize.yuv_front_value=150 \
    ...
    ro.camera.backdefault_rotation=1.3333 \
    ro.camera.backdefault_size=3840x2160 \
    ro.camera.predefault_rotation=1.3333 \
    ro.camera.predefault_size=3264x2448 \
    ro.carrier=unknown \
    ro.com.android.mobiledata=false \
    ro.com.google.acsa=true \
    ro.com.google.clientidbase=android-coosea \
    ro.com.google.gmsversion=8.1_201810.go \
    ro.config.alarm_alert=Alarm_Classic.ogg \
    ro.config.low_ram=true \
    ro.config.notification_sound=Han_message.ogg \
    ro.config.ringtone=incoming_call.ogg \
    ro.control_privapp_permissions=log \
    ro.def_mail_storage_permissions=1 \
    ro.email_support_ucs2=0 \
    ro.frp.pst=/dev/block/platform/mtk-msdc.0/11120000.msdc0/by-name/frp \
    ro.gangyun_bokeh_type=1 \
    ro.gangyun_camera_bokeh=1 \
    ro.have_aacencode_feature=1 \
    ro.have_aee_feature=1 \
    ro.hide_finger_func_menu=0 \
    ro.ksc5601_write=0 \
    ro.lmk.critical_upgrade=true \
    ro.lmk.upgrade_pressure=40 \
    ro.logd.size=256K \
    ro.media.maxmem=262144000 \
    ...
    ro.p_support_nav_bar_for_mback=1 \
    ro.prize.bangs.screen=1 \
    ro.prize.custom_imei_display=1 \
    ro.prize.faceid=1 \
    ro.prize.memery_switch=0 \
    ro.prize.project.ver=6 \
    ro.prize.statusbar.light.theme=1 \
    ro.prize_accelerometer_rotation=0 \
    ro.prize_add_thumbnail_fileman=0 \
    ro.prize_apn_order_name_desc=0 \
    ro.prize_app_cell_height=1 \
    ro.prize_ar_layout_ltr=0 \
    ro.prize_auto_time=1 \
    ro.prize_auto_time_zone=1 \
    ro.prize_battery_capacity=3200 \
    ro.prize_bg_power_saving_enable=1 \
    ro.prize_bluetooth=0 \
    ro.prize_board_network_type=WB/GB \
    ro.prize_brightness_mode=0 \
    ro.prize_browser_homepage=chrome-native://newtab \
    ro.prize_browser_yahoo_bookmarks_support=1 \
    ro.prize_build_ago=1 \
    ro.prize_calendar_monday_sort=0 \
    ro.prize_call_flash=1 \
    ro.prize_cts=1 \
    ro.prize_customer=coosea \
    ro.prize_customer_kb_kp=0 \
    ro.prize_customer_logo_icon=0 \
    ro.prize_def_development_settings=0 \
    ro.prize_def_emergency_tone=0 \
    ro.prize_def_front_mode_normal=1 \
    ro.prize_default_theme_path=system/media/config/theme/default/default.jar \
    ro.prize_default_value_call_flash=0 \
    ro.prize_default_value_show_battery_percent=0 \
    ro.prize_default_value_wireless_charger=1 \
    ro.prize_del_lan_switch_btn=0 \
    ro.prize_del_settings_gestures=1 \
    ro.prize_dialer_tab_index=0 \
    ro.prize_dialpad_always_show=0 \
    ro.prize_dtmf_tone_when_dialing=0 \
    ro.prize_factory_calibration01=0 \
    ro.prize_factory_test=1 \
    ro.prize_font_size=1.0 \
    ro.prize_fp_answer_call=0 \
    ro.prize_fp_music_player=0 \
    ro.prize_fp_return_back=0 \
    ro.prize_fp_return_home=0 \
    ro.prize_fp_screen_capture=0 \
    ro.prize_fp_slide_launcher=0 \
    ro.prize_fp_take_photo=0 \
    ro.prize_fp_video_player=0 \
    ro.prize_gallery_magnify=2 \
    ro.prize_gangyun_bokeh=true \
    ro.prize_gester_camera=1 \
    ro.prize_gms_fastpass_plus=1 \
    ro.prize_gms_russia=0 \
    ro.prize_gsensor_call_lf_screen=0 \
    ro.prize_hw_info=1 \
    ro.prize_imei_length=14 \
    ro.prize_increase_navbar_sensitivity=0 \
    ro.prize_intercept_wakeup_alarm=1 \
    ro.prize_is_language_adp_sim=1 \
    ro.prize_isdel_ZenModePriority=0 \
    ro.prize_isdel_simprocessor_notify=1 \
    ro.prize_isdelete_security_update=0 \
    ro.prize_isshow_fontstyle=0 \
    ro.prize_launcher_singleanddouble=0 \
    ro.prize_launcher_translucent=0 \
    ro.prize_led_switch_support=0 \
    ro.prize_lockscreen_sounds=1 \
    ro.prize_long_camera_key=1 \
    ro.prize_navba_style=1 \
    ro.prize_navbar_height=48 \
    ro.prize_number_min_match=7 \
    ro.prize_ownerinfo_maxlen=200 \
    ro.prize_preload_local_bookmark_suport=0 \
    ro.prize_recent_used_menu=0 \
    ro.prize_regaltory_legal=0 \
    ro.prize_remove_app_icon_background=0 \
    ro.prize_rm_bat_last_full_ch=1 \
    ro.prize_screen_brightness=206 \
    ro.prize_screen_off_timeout=60000 \
    ro.prize_setting_storage_avai=0 \
    ro.prize_short_camera_key=1 \
    ro.prize_show_battery_remaininglable=0 \
    ro.prize_show_device_memory=0 \
    ro.prize_show_device_storage=0 \
    ro.prize_show_main_camera=0 \
    ro.prize_show_screen_resolution=0 \
    ro.prize_show_screen_size=0 \
    ro.prize_show_sub_camera=0 \
    ro.prize_show_user_guide=0 \
    ro.prize_sms_to_mms_threshold=3 \
    ro.prize_stream_accessibility=12 \
    ro.prize_stream_alarm=12 \
    ro.prize_stream_bluetooth_sco=12 \
    ro.prize_stream_dtmf=3 \
    ro.prize_stream_music=12 \
    ro.prize_stream_notification=12 \
    ro.prize_stream_ring=12 \
    ro.prize_stream_system=12 \
    ro.prize_stream_system_enforced=12 \
    ro.prize_stream_tts=12 \
    ro.prize_stream_voice_call=12 \
    ro.prize_tee=1 \
    ro.prize_time_12_24=12 \
    ro.prize_touch_sounds=0 \
    ro.prize_vibrate_on_touch=1 \
    ro.prize_vibrate_when_ringing=0 \
    ro.prize_video_takeSnapshot=0 \
    ro.prize_wifi=0 \
    ro.prize_wireless_charger=0 \
    ro.setupwizard.mode=OPTIONAL \
    ro.sf.hwrotation=0 \
    ro.sf.lcd_density=240 \
    ro.sim_me_lock_mode=0 \
    ro.sim_refresh_reset_by_modem=1 \
    ro.support_hiding_navbar=1 \
    ro.sys.sdcardfs=1 \
